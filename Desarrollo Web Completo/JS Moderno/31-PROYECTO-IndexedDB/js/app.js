...
class UI {
  ...
  imprimirCitas() {
    ...
    // Esto retorna un registro de columnas en el indexedDB ... openCursor() es un iterador del indexedDB
...
function nuevaCita(e) {
  ...
  if (editando) {
    ...
    // Insertamos Reegistro en IndexedDB
    //  readweit es para leer y escribir dentro de la base de datos
    const transaction = DB.transaction(['citas'], 'readwrite');

    const objectStore = transaction.objectStore('citas');

    objectStore.add(citaObj);
    // transaction.oncomplete es un evento que se ejecuta cuando la transacción se completa
...
function crearDB() {
  ...
  crearDB.onsuccess = function () {
    ...
    DB = crearDB.result;
    // mostrarcitas  al cargar (indexdb esta listo)
    ui.imprimirCitas();
  };
